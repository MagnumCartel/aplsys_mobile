  ...
  Future<void> _submitForm() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: Text("Confirm Leave Request?"),
        content: Text(
          "Type: $_selectedType\n"
    ...
    try {
      ...
      await SupabaseConfig.client.from('leave').insert({
        ...
        'if_other': _selectedType == 'Other' ? _otherTypeController.text : null,
        'status': 'Pending',
      });
      ...
      debugPrint("❌ Error submitting leave request: $error");
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Error submitting leave request: $error")),
      );
    }
  }
